...
import { 
  ...
  ChevronRight, RefreshCcw, Check, Sparkles, AlertTriangle, HelpCircle, Play, Info
} from 'lucide-react';
              ...
              {filteredSteps.map((step) => {
                ...
                return (
                  <motion.div
                    ...
                    className="bg-husk-beige/10 border-2 border-shell-brown/10 rounded-3xl overflow-hidden shadow-md hover:shadow-xl hover:border-eco-green/35 transition-all duration-300 flex flex-col justify-between group"
                  >
                    {/* Top Image area */}
