      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between gap-4">
          ...
          <div 
            ...
            id="headerLogo"
          >
            <div className="w-10 h-10 rounded-xl bg-husk-beige/10 p-0.5 flex items-center justify-center shadow-md group-hover:scale-105 transition-transform shrink-0 border border-shell-brown/10">
